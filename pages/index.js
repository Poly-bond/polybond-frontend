                ...
                <div className="nav__links-wrp">
                  ...
                  >
                    <div className="btn-text-cont">
                      <div className="btn-text-ghost">Enter App</div>
                      <div className="btn-text">Enter App</div>
                    </div>
                  </a>
                </div>
              </div>
                        ...
                        <div className="w-slide">
                          <div className="pr-partners__grid">
                            <div id="w-node-d0c714ac-3ae4-776a-6ade-e1027615a28d-d3c7e579">
                              ...
                              >
                                <h3 className="t-24">Barnbridge</h3>
                                <img
                                  src="../assets.website-files.com/621f51702b01b7fee7ff903a/6228bdff9cbae002e69cd378_logo-11.svg"
                                  loading="lazy"
                                  alt="BarnBridge"
                              ...
                              <a
                                ...
                                className="pr-partners__link w-inline-block"
                              >
                                <h3 className="t-24">Pendle</h3>
                                <img
                                  src="../assets.website-files.com/621f51702b01b7fee7ff903a/6228be8e1a161756a596a3b8_logo-4.png"
                                  loading="lazy"
                                  alt="Pendle"
                                  className="pr-partners__link-icon"
                                />
                              ...
                              <a
                                ...
                                className="pr-partners__link w-inline-block"
                              >
                                <h3 className="t-24">Inverse Finance</h3>
                                <img
                                  src="../assets.website-files.com/621f51702b01b7fee7ff903a/6228be016c24f2a47443f845_logo-7.svg"
                                  loading="lazy"
                                  alt="Inverse Finance"
                                  className="pr-partners__link-icon"
                                />
                            ...
                            <div id="w-node-d0c714ac-3ae4-776a-6ade-e1027615a29a-d3c7e579">
                              <a
                                ...
                                className="pr-partners__link w-inline-block"
                              >
                                <h3 className="t-24">Alchemix</h3>
                                <img
                                  src="../assets.website-files.com/621f51702b01b7fee7ff903a/6228bdfe449206f01319bede_logo-10.svg"
                                  loading="lazy"
                                  alt="Alchemix"
                                  className="pr-partners__link-icon"
                                />
                              ...
                              <a
                                ...
                                className="pr-partners__link w-inline-block"
                              >
                                <h3 className="t-24">StakeDAO</h3>
                                <img
                                  src="../assets.website-files.com/621f51702b01b7fee7ff903a/6228be8e8516d68d05b825b9_logo-3.png"
                                  loading="lazy"
                                  alt="StakeDAO"
                                  className="pr-partners__link-icon"
                                />
                              ...
                              <a
                                ...
                                className="pr-partners__link w-inline-block"
                              >
                                <h3 className="t-24">Pool Together</h3>
                                <img
                                  src="../assets.website-files.com/621f51702b01b7fee7ff903a/6228bdfe1eb29adfc2b1fd91_logo-6.svg"
                                  loading="lazy"
                                  alt="Pool Together"
                                  className="pr-partners__link-icon"
                                />
                            ...
                            <div id="w-node-d0c714ac-3ae4-776a-6ade-e1027615a2a7-d3c7e579">
                              <a
                                ...
                                className="pr-partners__link w-inline-block"
                              >
                                <h3 className="t-24">Float</h3>
                                <img
                                  src="../assets.website-files.com/621f51702b01b7fee7ff903a/6228be8e93efe77a2e66c999_logo-2.png"
                                  loading="lazy"
                                  alt="Float"
                                  className="pr-partners__link-icon"
                                />
                              ...
                              <a
                                ...
                                className="pr-partners__link w-inline-block"
                              >
                                <h3 className="t-24">Synapse</h3>
                                <img
                                  src="../assets.website-files.com/621f51702b01b7fee7ff903a/6228be8e493b8ebd8457174a_logo-1.png"
                                  loading="lazy"
                                  alt="Synapse"
                                  className="pr-partners__link-icon"
                                />
                              ...
                              <a
                                ...
                                className="pr-partners__link w-inline-block"
                              >
                                <h3 className="t-24">Liquid Driver</h3>
                                <img
                                  src="../assets.website-files.com/621f51702b01b7fee7ff903a/6228bdfdb3fc545dec816495_logo-1.svg"
                                  loading="lazy"
                                  alt="Liquid Driver"
                                  className="pr-partners__link-icon"
                                />
                            ...
                            <div id="w-node-d0c714ac-3ae4-776a-6ade-e1027615a2b4-d3c7e579">
                              <a
                                ...
                                className="pr-partners__link w-inline-block"
                              >
                                <h3 className="t-24">Frax</h3>
                                <img
                                  src="../assets.website-files.com/621f51702b01b7fee7ff903a/6228bdfe725c5970de1ac2cb_logo-5.svg"
                                  loading="lazy"
                                  alt="Frax"
                                  className="pr-partners__link-icon"
                                />
                              ...
                              <a
                                ...
                                className="pr-partners__link w-inline-block"
                              >
                                <h3 className="t-24">Thorstarter</h3>
                                <img
                                  src="../assets.website-files.com/621f51702b01b7fee7ff903a/6228bdfdc86b1033a01925e5_logo-2.svg"
                                  loading="lazy"
                                  alt="Thorstarter"
                                  className="pr-partners__link-icon"
                                />
                              ...
                              <a
                                ...
                                className="pr-partners__link w-inline-block"
                              >
                                <h3 className="t-24">Spooky Finance</h3>
                                <img
                                  src="../assets.website-files.com/621f51702b01b7fee7ff903a/6228be8ffe5d987922a94f15_logo.png"
                                  loading="lazy"
                                  alt="Spooky Finance"
                                  className="pr-partners__link-icon"
                                />
                ...
                <div className="horizontal-container">
                  <div className="vertical-center">
                    ...
                    <div className="max-width-1300">
                      <div className="slide-in">
                        {/* <img src="build-bg.png" loading="lazy" srcSet="build-bg.png 500w, build-bg.png 800w, build-bg.png 1080w, build-bg.png 1950w" sizes="100vw" alt="" className="cta-prefooter__img"/> */}
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <div className="footer__container">
                  ...
                  {/* <div id="w-node-_53e45fb5-9d72-c442-cbd6-6edd3639f0fe-3639f0d9">
                    ...
                    <div>
                      ...
                      <div className="mar-bot-32">
                        <a href="blog.html" className="nav__link">
                          BLOG
                        </a>
                      </div>
                      <div>
              ...
              <div className="horizontal-container">
                <div className="footer__container">
                  ...
                  >
                    ...
                    >
                      <img
                        src="../assets.website-files.com/621f51702b01b7fee7ff903a/63076b7cea503d9816cd44b8_Climate_Positive_Protocol_Button_2.svg"
                        loading="lazy"
                        id="w-node-_5c8e9900-dc7b-93fd-960d-1a3e4f4ff0bd-3639f0d9"
                        alt=""
                        className="image-53"
                      />
                    </a>
